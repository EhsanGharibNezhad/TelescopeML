...
#             #import IPython; IPython.embed()
    ...
    def get_configspace():
        ...
        Conv__filters = UniformIntegerHyperparameter(name='Conv__filters', lower=4, upper=32, default_value=16,  log=False)
        ...
        Conv__NumberLayers = UniformIntegerHyperparameter(name='Conv__NumberLayers', lower=1, upper=6, default_value=1,  log=False)
