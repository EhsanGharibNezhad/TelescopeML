...
NS = hpns.NameServer(run_id='example4', host=ip_address, port=None)
NS.start()


# Run an optimizer (see example_2)

result_logger = hpres.json_result_logger(directory='/data2/ehsan_storage/telescopeML/core_codes/bohb_tuning/out24/', overwrite=True)
