...
cnn_model.X2_train, cnn_model.X2_val, cnn_model.X2_test = cnn_model.StandardScaler_col_X_3(X_train = cnn_model.X2_train,
...
cnn_model.X_train, cnn_model.X_val, cnn_model.X_test =  cnn_model.StandardScaler_row_X_3(X_train = cnn_model.X_train.drop(columns=['min','max']),
...
cnn_model.StandardScaler_column_y_3()
...
parser.add_argument('--n_iterations', type=int,   help='Number of iterations performed by the optimizer', default=40)
parser.add_argument('--n_workers', type=int,   help='Number of workers to run in parallel.', default = 48 )
